...
//   При събиране, изваждане и умножение на конзолата трябва да се отпечатат резултата и дали той е четен или нечетен. При обикновеното деление – резултата. При модулното деление – остатъка. 
...
function operationsBetweenNumbers(input) {
    ...
    if (operator == "+") {
        ...
        if (result % 2 == 0) {
            ...
            character = 'odd';
        } console.log(`${N1} ${operator} ${N2} = ${result} - ${character}`);
    } else if (operator == "-") {
        result = N1 - N2;
        if (result % 2 == 0) {
            character = "even";
