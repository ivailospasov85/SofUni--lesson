function fishTank(input) {
    ...
    let fishTankprocentish = Number(input[3])/100
    let litreOfWater = fishTankWidth * fishTankHeight * fishTankLength / 1000
    let litreOfWaterAfterSand = litreOfWater - (litreOfWater * fishTankprocentish)
    console.log(litreOfWaterAfterSand)
