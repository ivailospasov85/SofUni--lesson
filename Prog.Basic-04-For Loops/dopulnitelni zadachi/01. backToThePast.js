...
//   Като приемем, че за всяка четна (1800, 1802 и т.н.) година ще харчи 12 000 лева. За всяка нечетна (1801,1803  и т.н.) ще харчи 12 000 + 50 * [годините, които е навършил през дадената година].
// Вход
...
function backToThePast(input) {
    ...
    let ivanchoYars = 18;
    let year1800 = 1800;
    let bonusYearsCounter = -1


    for (let i = year1800; i <= yearToLive; i++) {
        ...
        if (i % 2 == 0) {
            ...
            money -= 12000 + (50 * (ivanchoYars + bonusYearsCounter))
        }
    }
    if (money <= 0) {
